<template>
  ...
  <p class="mt-3 leading-8">
    ...
    gameplay. You can make shops and trade your valuable items, make farm to get money, and battle toe to toe with any other player in our arena. We also allow player to sell
    or buy/rent claim lands or buildings, to make or be part of a town, including our own.
  </p>

  <p class="mt-3 leading-8">We strive to make the server better and improve time by time with the help of everyone in our community.</p>
